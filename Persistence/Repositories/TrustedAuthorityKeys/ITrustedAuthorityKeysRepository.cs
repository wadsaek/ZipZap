// ITrustedAuthorityKeysRepository.cs - Part of the ZipZap project for storing files online
...
public interface ITrustedAuthorityKeysRepository : IRepository<Key, KeyId> {
    ...
    public Task<IEnumerable<Key>> GetByKey(SshPublicKey key, CancellationToken cancellationToken = default);
}
