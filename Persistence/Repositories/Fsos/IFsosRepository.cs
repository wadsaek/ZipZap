...
public interface IFsosRepository : IRepository<Fso, FsoId> {
    ...
    public Task<Result<Unit, DbError>> DeleteAsync(FsoId fso, DeleteOptions options, CancellationToken cancellationToken);
    public Task<IEnumerable<File>> GetAllChildFilesAsync(FsoId parent, CancellationToken cancellationToken);
}
